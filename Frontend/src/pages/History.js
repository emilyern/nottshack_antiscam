...
import {
  ArrowUpRight, ArrowDownLeft, RefreshCw, Filter, Shield,
} from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#020617' }}>
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '28px 24px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
          <div>
            <h1 style={{ margin: 0, fontSize: '22px', fontWeight: 800, color: '#f8fafc' }}>Transaction History</h1>
        ...
        <div style={tableWrap}>
          {/* Fixed: header and data rows now use the same 6-column grid */}
          <div style={headerRow}>
...
// Fixed: both headerRow and dataRow now use identical 6-column grid
